...
IVFDTcpSocket::IVFDTcpSocket(qintptr socketDescriptor, QObject *parent) :
    QTcpSocket(parent),
...
IVFDTcpSocket::~IVFDTcpSocket()
{
    this->disconnectFromHost();
    this->deleteLater();
}

void IVFDTcpSocket::sendData(QString data, const int id)
{
...
void IVFDTcpSocket::disConnectTcp(int id)
{
    if(id == socketID)
    {
        this->disconnectFromHost();
