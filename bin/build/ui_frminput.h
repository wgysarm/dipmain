...
public:
    ...
    void setupUi(QWidget *frmInput)
    {
        ...
        widget_title->setEnabled(true);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(widget_title->sizePolicy().hasHeightForWidth());
        widget_title->setSizePolicy(sizePolicy);
        widget_title->setMinimumSize(QSize(590, 0));
        widget_title->setMaximumSize(QSize(720, 16777215));
        QFont font;
        ...
        QFont font3;
        font3.setFamily(QStringLiteral("WenQuanYi Zen Hei"));
        font3.setPointSize(9);
        btnPre->setFont(font3);
        ...
        sizePolicy.setHeightForWidth(labCh0->sizePolicy().hasHeightForWidth());
        labCh0->setSizePolicy(sizePolicy);
        labCh0->setMinimumSize(QSize(0, 25));
        labCh0->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh1->sizePolicy().hasHeightForWidth());
        labCh1->setSizePolicy(sizePolicy);
        labCh1->setMinimumSize(QSize(0, 25));
        labCh1->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh2->sizePolicy().hasHeightForWidth());
        labCh2->setSizePolicy(sizePolicy);
        labCh2->setMinimumSize(QSize(0, 25));
        labCh2->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh3->sizePolicy().hasHeightForWidth());
        labCh3->setSizePolicy(sizePolicy);
        labCh3->setMinimumSize(QSize(0, 25));
        labCh3->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh4->sizePolicy().hasHeightForWidth());
        labCh4->setSizePolicy(sizePolicy);
        labCh4->setMinimumSize(QSize(0, 25));
        labCh4->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh5->sizePolicy().hasHeightForWidth());
        labCh5->setSizePolicy(sizePolicy);
        labCh5->setMinimumSize(QSize(0, 25));
        labCh5->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh6->sizePolicy().hasHeightForWidth());
        labCh6->setSizePolicy(sizePolicy);
        labCh6->setMinimumSize(QSize(0, 25));
        labCh6->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh7->sizePolicy().hasHeightForWidth());
        labCh7->setSizePolicy(sizePolicy);
        labCh7->setMinimumSize(QSize(0, 25));
        labCh7->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh8->sizePolicy().hasHeightForWidth());
        labCh8->setSizePolicy(sizePolicy);
        labCh8->setMinimumSize(QSize(0, 25));
        labCh8->setFont(font2);
        ...
        sizePolicy.setHeightForWidth(labCh9->sizePolicy().hasHeightForWidth());
        labCh9->setSizePolicy(sizePolicy);
        labCh9->setMinimumSize(QSize(0, 25));
        labCh9->setFont(font2);
        ...
        sizePolicy3.setHeightForWidth(widgetMain->sizePolicy().hasHeightForWidth());
        widgetMain->setSizePolicy(sizePolicy3);
        ...
        gridLayout->addWidget(btnOther13, 1, 13, 1, 1);
        ...
        gridLayout->addWidget(btn6, 1, 17, 1, 1);
        ...
        gridLayout->addWidget(btn9, 0, 17, 1, 1);
        ...
        gridLayout->addWidget(btn8, 0, 16, 1, 1);

        spacer = new QSpacerItem(15, 20, QSizePolicy::Minimum, QSizePolicy::Minimum);

        gridLayout->addItem(spacer, 0, 14, 1, 1);
        ...
        gridLayout->addWidget(btn3, 2, 17, 1, 1);
        ...
        gridLayout->addWidget(btnOther15, 2, 12, 1, 1);
        ...
        gridLayout->addWidget(btnOther11, 0, 12, 1, 1);
        ...
        gridLayout->addWidget(btn5, 1, 16, 1, 1);
        ...
        gridLayout->addWidget(btn0, 4, 15, 1, 1);
        ...
        gridLayout->addWidget(btn4, 1, 15, 1, 1);
        ...
        gridLayout->addWidget(btnOther16, 2, 13, 1, 1);
        ...
        gridLayout->addWidget(btn7, 0, 15, 1, 1);
        ...
        gridLayout->addWidget(btn00, 4, 16, 1, 1);
        ...
        gridLayout->addWidget(btn1, 2, 15, 1, 1);
        ...
        gridLayout->addWidget(btn2, 2, 16, 1, 1);
        ...
        gridLayout->addWidget(btnDelete, 0, 13, 1, 1);
        ...
        btnSpace->setFont(font3);
        btnSpace->setFocusPolicy(Qt::NoFocus);

        gridLayout->addWidget(btnSpace, 4, 9, 1, 2);
    ...
    {
        frmInput->setWindowTitle(QApplication::translate("frmInput", "\344\270\255\346\226\207\350\276\223\345\205\245\346\263\225\351\235\242\346\235\277", 0));
        lab_Title->setText(QApplication::translate("frmInput", "  \344\270\255\346\226\207\350\276\223\345\205\245\346\263\225--\345\260\217\345\206\231", 0));
        labPY->setText(QString());
        btnPre->setText(QApplication::translate("frmInput", "<", 0));
        btnNext->setText(QApplication::translate("frmInput", ">", 0));
        btnClose->setText(QApplication::translate("frmInput", "\345\205\263\351\227\255", 0));
        ...
        btnOther17->setText(QApplication::translate("frmInput", ",", 0));
        btnt->setText(QApplication::translate("frmInput", "t", 0));
        btnOther13->setText(QApplication::translate("frmInput", "|", 0));
        btnOther19->setText(QApplication::translate("frmInput", "(", 0));
        btnm->setText(QApplication::translate("frmInput", "m", 0));
        btnOther1->setText(QApplication::translate("frmInput", "!", 0));
        btn6->setText(QApplication::translate("frmInput", "6", 0));
        btn9->setText(QApplication::translate("frmInput", "9", 0));
        btnc->setText(QApplication::translate("frmInput", "c", 0));
        btnl->setText(QApplication::translate("frmInput", "l", 0));
        btns->setText(QApplication::translate("frmInput", "s", 0));
        btnOther7->setText(QApplication::translate("frmInput", "&&", 0));
        btn8->setText(QApplication::translate("frmInput", "8", 0));
        btnOther5->setText(QApplication::translate("frmInput", "%", 0));
        btn3->setText(QApplication::translate("frmInput", "3", 0));
        btnx->setText(QApplication::translate("frmInput", "x", 0));
        btnOther15->setText(QApplication::translate("frmInput", "?", 0));
        btno->setText(QApplication::translate("frmInput", "o", 0));
        btng->setText(QApplication::translate("frmInput", "g", 0));
        btnj->setText(QApplication::translate("frmInput", "j", 0));
        btnf->setText(QApplication::translate("frmInput", "f", 0));
        btnOther11->setText(QApplication::translate("frmInput", "+", 0));
        btnDot->setText(QApplication::translate("frmInput", ".", 0));
        btnu->setText(QApplication::translate("frmInput", "u", 0));
        btnOther2->setText(QApplication::translate("frmInput", "@", 0));
        btn5->setText(QApplication::translate("frmInput", "5", 0));
        btnOther18->setText(QApplication::translate("frmInput", "\\", 0));
        btnb->setText(QApplication::translate("frmInput", "b", 0));
        btn0->setText(QApplication::translate("frmInput", "0", 0));
        btn4->setText(QApplication::translate("frmInput", "4", 0));
        btnOther16->setText(QApplication::translate("frmInput", "=", 0));
        btnOther12->setText(QApplication::translate("frmInput", "/", 0));
        btnv->setText(QApplication::translate("frmInput", "v", 0));
        btne->setText(QApplication::translate("frmInput", "e", 0));
        btni->setText(QApplication::translate("frmInput", "i", 0));
        btnh->setText(QApplication::translate("frmInput", "h", 0));
        btnOther3->setText(QApplication::translate("frmInput", "#", 0));
        btn7->setText(QApplication::translate("frmInput", "7", 0));
        btna->setText(QApplication::translate("frmInput", "a", 0));
        btnn->setText(QApplication::translate("frmInput", "n", 0));
        btnType->setText(QApplication::translate("frmInput", "\345\260\217\345\206\231", 0));
        btnOther6->setText(QApplication::translate("frmInput", "^", 0));
        btnd->setText(QApplication::translate("frmInput", "d", 0));
        btnOther4->setText(QApplication::translate("frmInput", "$", 0));
        btnz->setText(QApplication::translate("frmInput", "z", 0));
        btn00->setText(QApplication::translate("frmInput", "00", 0));
        btn1->setText(QApplication::translate("frmInput", "1", 0));
        btnk->setText(QApplication::translate("frmInput", "k", 0));
        btn2->setText(QApplication::translate("frmInput", "2", 0));
        btnw->setText(QApplication::translate("frmInput", "w", 0));
        btnr->setText(QApplication::translate("frmInput", "r", 0));
        btnDelete->setText(QApplication::translate("frmInput", "\342\206\220", 0));
        btnOther8->setText(QApplication::translate("frmInput", "*", 0));
        btnq->setText(QApplication::translate("frmInput", "q", 0));
        btny->setText(QApplication::translate("frmInput", "y", 0));
        btnOther20->setText(QApplication::translate("frmInput", ")", 0));
        btnp->setText(QApplication::translate("frmInput", "p", 0));
        btnOther14->setText(QApplication::translate("frmInput", ":", 0));
        btnSpace->setText(QApplication::translate("frmInput", "\347\251\272\346\240\274", 0));
        btnOther9->setText(QApplication::translate("frmInput", "-", 0));
        btnOther10->setText(QApplication::translate("frmInput", "_", 0));
        btnOther21->setText(QApplication::translate("frmInput", "\"", 0));
    } // retranslateUi
