...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_frmNum_t, stringdata) + ofs \
...
const QMetaObject frmNum::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_frmNum.data,
      qt_meta_data_frmNum,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *frmNum::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_frmNum.stringdata))
        return static_cast<void*>(const_cast< frmNum*>(this));
