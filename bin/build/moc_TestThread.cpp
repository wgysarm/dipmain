...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TestThread_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestThread_t qt_meta_stringdata_TestThread = {
    {
QT_MOC_LITERAL(0, 0, 10), // "TestThread"
QT_MOC_LITERAL(1, 11, 15), // "SIG_StartThread"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 14), // "SIG_StopThread"
QT_MOC_LITERAL(4, 43, 16), // "SLOT_StartThread"
QT_MOC_LITERAL(5, 60, 15) // "SLOT_StopThread"

    },
    "TestThread\0SIG_StartThread\0\0SIG_StopThread\0"
    "SLOT_StartThread\0SLOT_StopThread"
};
...
void TestThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->SIG_StartThread(); break;
        case 1: _t->SIG_StopThread(); break;
        case 2: _t->SLOT_StartThread(); break;
        case 3: _t->SLOT_StopThread(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestThread::SIG_StartThread)) {
                *result = 0;
            }
        }
        {
            typedef void (TestThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestThread::SIG_StopThread)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject TestThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestThread.data,
...
void *TestThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestThread.stringdata))
...
// SIGNAL 0
void TestThread::SIG_StartThread()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void TestThread::SIG_StopThread()
{
